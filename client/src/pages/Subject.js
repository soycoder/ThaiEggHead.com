            ...
            <Card>
              ...
              <Card.ImgOverlay>
                ...
                <Col xs={2}>
                  ...
                  <Card.Img src={images.subj_1} height="200" width="50" 
                    style={{ width: '13rem' }} 
        ...
        <Row>
          ...
          {forumData.map((forum) => (
            <>
              <Card >
                <Row>
                  <Col xs={2} className="app-profile" ><img src={images.pro_2} height="30" width="30" className="app-cycle"/><p/>pop fever</Col>
                  <Col xs={10} className="app-paddingContent">
                    <Card.Title >{forum.title}</Card.Title>
                    <Card.Subtitle className="mb-2 text-muted"> {forum.postText}</Card.Subtitle>
                  </Col>
                </Row>
              </Card>
              <p/>
